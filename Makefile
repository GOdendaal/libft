...
SRC = ft_atoi.c ft_memset.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_bzero.c \
    ...
    ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c ft_isdigit.c \
	...
	ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_itoa.c ft_putchar.c ft_putstr.c ft_putendl.c \
	ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c

OBJ = ft_atoi.o ft_memset.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_bzero.o \
    ...
    ft_isascii.o ft_isprint.o ft_toupper.o ft_tolower.o ft_isdigit.o \
	...
	ft_strjoin.o ft_strtrim.o ft_strsplit.o ft_itoa.o ft_putchar.o ft_putstr.o ft_putendl.o \
